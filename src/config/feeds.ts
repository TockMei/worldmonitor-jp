...
const FULL_FEEDS: Record<string, Feed[]> = {
  ...
  asia: [
    ...
    { name: 'NHK World', url: rss('https://www3.nhk.or.jp/rss/news/cat0.xml') },
    { name: 'Nikkei Asia', url: rss('https://asia.nikkei.com/rss') },
    { name: 'Nikkei Business', url: rss('https://business.nikkei.com/rss/sns/nb.rdf') },
    { name: 'Japan Times', url: rss('https://www.japantimes.co.jp/feed/') },
    { name: 'Kyodo News', url: rss('https://english.kyodonews.net/rss/news.xml') },
  ],
  energy: [
