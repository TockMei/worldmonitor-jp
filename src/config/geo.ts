...
export const INTEL_HOTSPOTS: Hotspot[] = [
  ...
  // イラン関連ホットスポット
  {
    ...
    subtext: 'Oil Chokepoint',
    lat: 26.56,
    lon: 56.25,
    location: 'Persian Gulf / Oman Sea',
    keywords: ['hormuz', 'strait of hormuz', 'persian gulf', 'iran navy'],
    agencies: ['IRGC Navy', 'US 5th Fleet', 'Royal Navy Oman'],
    description: '世界の石油輸送の約20%が通過する戦略的チョークポイント。イランによる封鎖リスク。',
    status: 'Monitoring',
    escalationScore: 4,
    escalationTrend: 'escalating',
    escalationIndicators: ['IRGC vessel harassment', 'Tanker seizures', 'Mine threats', 'US carrier presence'],
    whyItMatters: 'Global oil flow chokepoint; closure would trigger energy crisis; US-Iran flashpoint',
  },
  {
    id: 'bushehr',
    name: 'Bushehr Nuclear Plant',
    subtext: 'Iran Nuclear',
    lat: 28.83,
    lon: 50.88,
    location: 'Bushehr Province, Iran',
    keywords: ['bushehr', 'nuclear', 'iran nuclear', 'IAEA'],
    agencies: ['AEOI', 'IAEA', 'Rosatom'],
    description: 'イラン唯一の稼働中原子力発電所。ロシア建設・運営。IAEA査察対象。',
    status: 'Monitoring',
    whyItMatters: 'Civilian nuclear site with dual-use concerns; Russian influence leverage; IAEA monitoring focus',
  },
  {
    id: 'natanz',
    name: 'Natanz Nuclear Facility',
    subtext: 'Enrichment Site',
    lat: 33.72,
    lon: 51.73,
    location: 'Isfahan Province, Iran',
    keywords: ['natanz', 'uranium', 'enrichment', 'centrifuge'],
    agencies: ['AEOI', 'IRGC', 'IAEA'],
    description: 'イランの主要ウラン濃縮施設。60%濃縮実施。Stuxnet攻撃対象（2010年）。',
    status: 'Monitoring',
    escalationScore: 5,
    escalationTrend: 'escalating',
    escalationIndicators: ['60% enrichment ongoing', 'IAEA access restrictions', 'Advanced centrifuge deployment', 'Sabotage incidents'],
    whyItMatters: 'Core of Iranian nuclear weapons breakout capacity; 90% enrichment threshold proximity',
  },
  {
    id: 'bandar_abbas',
    name: 'Bandar Abbas Naval Base',
    subtext: 'IRGC Navy HQ',
    lat: 27.19,
    lon: 56.27,
    location: 'Hormozgan Province, Iran',
    keywords: ['bandar abbas', 'iran navy', 'IRGC navy'],
    agencies: ['IRGC Navy', 'Islamic Republic of Iran Navy'],
    description: 'イラン海軍・IRGC海軍の主要基地。ホルムズ海峡制圧の拠点。',
    status: 'Monitoring',
    escalationScore: 3,
    escalationTrend: 'stable',
    escalationIndicators: ['Fast boat deployments', 'Tanker harassment ops', 'Drone boat tests'],
    whyItMatters: 'Controls Hormuz strait access; IRGC naval power projection hub',
  },
  {
    id: 'chabahar',
    name: 'Chabahar Port',
    subtext: 'India-Iran Gateway',
    lat: 25.29,
    lon: 60.64,
    location: 'Sistan-Baluchestan, Iran',
    keywords: ['chabahar', 'iran port', 'india iran'],
    agencies: ['India Ports Global', 'Iranian Port Authority', 'INSTC'],
    description: 'インドが開発するイラン南東部の深海港。パキスタン迂回でアフガン・中央アジア向け貿易ルート。',
    status: 'Monitoring',
    whyItMatters: 'India-Iran strategic corridor; US sanctions exemption test case; China BRI counter-balance',
  },
];
